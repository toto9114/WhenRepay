...
public class SendDutchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (PersonData data : dutchPayData.personList) {
            Log.i("dutch", "name: " + data.name);
        }
        mAdapter = new ArrayAdapter<PersonData>(getContext(), android.R.layout.simple_list_item_1);
    ...
    private void initData() {
        ...
        totalView.setText("" + dutchPayData.eventList.get(0).money);
